...
const winter = new Season('Miami', '35', 'Martes, 23 de Agosto', '80', '20', '<i class="fa-solid fa-rainbow"></i>', 'Miameee');
const spring = new Season('California', '25', 'Viernes, 31 de Septiembre', '90', '0 ', '<i class="fa-solid fa-meteor"></i>', 'Meteoritos!!');
